...
# 🔥 News
&nbsp;🎉🎉 We have some **fully funded openings** for **1) PhD Student**, **2) Postdoctoral Researcher**, and **3) Research Assistant** to work and have fun together on multiple research projects. Drop me an email ([wenchao.xu@polyu.edu.hk](https://www.polyu.edu.hk/comp/)) with your complete CV if you are interested. Candidates with strong backgrounds are preferred. **Visiting Students/Researchers** (onsite/remote) are also welcome!
